...
public class PlayerScript : MonoBehaviour
{
    ...
    // Ground Check Variables is floor because I used that name
    private bool isOnFloor;
    public Transform floorcheck;
    public float checkRadius;
    public LayerMask allFloor;
    ...
    void FixedUpdate()
    {
        ...
        // Ground Check
        isOnFloor = Physics2D.OverlapCircle(floorcheck.position, checkRadius, allFloor);
    ...
    {
        // Jump code
        if (collision.collider.tag == "Floor" && isOnFloor)
        {
